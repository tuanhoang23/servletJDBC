...
<%-- <div id="navbar" class="navbar navbar-default ace-save-state">
	<div class="navbar-container ace-save-state" id="navbar-container">
		<div class="navbar-header">
			<a href="#" class="navbar-brand"> <small> <i class="fa-solid fa-user-tie"></i> Trang quản trị</small>
			</a>
		</div>
		<div
...
<nav class="navbar navbar-expand navbar-light navbar-bg mb-0"> <a
	class="sidebar-toggle js-sidebar-toggle"> <i
...
<div class="navbar-collapse collapse">
	...
	<ul class="navbar-nav navbar-align">
		<li class="d-flex justify-content-center py-4"><span class="h1 ">TRANG
				QUẢN TRỊ</span></li>
		<li class="nav-item dropdown"><a class="nav-icon dropdown-toggle"
			href="#" id="alertsDropdown" data-bs-toggle="dropdown">
		...
		<li class="nav-item dropdown"><a class="nav-icon dropdown-toggle"
			href="#" id="messagesDropdown" data-bs-toggle="dropdown">
				<div class="position-relative">
		...
		<li class="nav-item dropdown"><a
			...
			data-bs-toggle="dropdown"> <img src="img/avatars/avatar.jpg"
				class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span
				class="text-dark">Wellcome,${USERMODEL.fullName}</span>
		</a>
<%--			<a class="nav-link" href="#!">Wellcome,${USERMODEL.fullName}</a>--%>
			<div class="dropdown-menu dropdown-menu-end">
				...
				<a class="dropdown-item" href="index.html"><i
					...
					Center</a>
				<div class="dropdown-divider"></div>
				<a class="dropdown-item" href="<c:url value='/logout?action=logout'/>">Log out</a>
			</div></li>
	</ul>
</div>
</nav>
